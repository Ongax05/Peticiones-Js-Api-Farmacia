...
export async function PutProveedor(id, nombre, email, telefono, direccion, token) {
  ...
  export function GetTotalDrugsSoldPerProvider(token) {
    return new Promise(async (resolve, reject) => {
      try {
  
        const response = await fetch(url+ `/GetTotalDrugsSold`, {
          method: "GET",
          headers: {
            "Content-Type": "application/json",
            Authorization: `Bearer ${token}`,
  ...
  export function ProvidersWhoHaveNotSoldInLastYear(token) {
    return new Promise(async (resolve, reject) => {
      try {
  
        const response = await fetch(url+ `/ProvidersWhoHaveNotSoldInLastYear`, {
          method: "GET",
          headers: {
            "Content-Type": "application/json",
            Authorization: `Bearer ${token}`,
  ...
  export function SuppliersWithFiveOrMoreKindsOfMedicine(firtsDate,lastDate,token) {
    return new Promise(async (resolve, reject) => {
      try {
  
        const response = await fetch(url+ `/SuppliersWithFiveOrMoreKindsOfMedicine?firtsDate=${firtsDate}&lastDate=${lastDate}`, {
          method: "GET",
          headers: {
            "Content-Type": "application/json",
            Authorization: `Bearer ${token}`,
