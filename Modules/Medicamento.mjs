...
export async function PutMedicamento(id, Nombre,Precio,Stock,FechaExpiracion,ProovedorId, token) {
  ...
  export function GetUnsoldDrug(token) {
    return new Promise(async (resolve, reject) => {
      try {
  
        const response = await fetch(url+`/GetUnsoldDrug`, {
          method: "GET",
          headers: {
            "Content-Type": "application/json",
            Authorization: `Bearer ${token}`,
  ...
  export function GetMostExpensiveDrug(token) {
    return new Promise(async (resolve, reject) => {
      try {
  
        const response = await fetch(url+`/GetMostExpensiveDrug`, {
          method: "GET",
          headers: {
            "Content-Type": "application/json",
            Authorization: `Bearer ${token}`,
  ...
  export function GetLeastSoldDrug(token) {
    return new Promise(async (resolve, reject) => {
      try {
  
        const response = await fetch(url+`/GetLeastSoldDrug`, {
          method: "GET",
          headers: {
            "Content-Type": "application/json",
            Authorization: `Bearer ${token}`,
  ...
  export function GetTotalDrugSoldPer(firtsDate,lastDate,token) {
    return new Promise(async (resolve, reject) => {
      try {
  
        const response = await fetch(url+ `/GetTotalDrugSoldPer?firtsDate=${firtsDate}&lastDate=${lastDate}`, {
          method: "GET",
          headers: {
            "Content-Type": "application/json",
            Authorization: `Bearer ${token}`,
