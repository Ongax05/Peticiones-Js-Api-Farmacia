...
import {DeleteMedicamento, PostMedicamento,GetMedicamentos, PutMedicamento,GetLessThan50,GetMedicamentoProveedor } from "./Modules/Medicamento.mjs";
...
import {DeleteMedicamentoVendido, PostMedicamentoVendido,GetMedicamentosVendidos, PutMedicamentoVendido,GetDrugSoldAfter,GetTotalDrugSold } from "./Modules/MedicamentoVendido.mjs";
var token = await GetToken("Admin", "Admin");
console.log(await GetTotalDrugSold("Lorataina",token))
