...
import {DeleteEmpleado, PostEmpleado,GetEmpleados, PutEmpleado, GetSalesPerEmployee,GetEmployeesWithFiveSalesOrMore,EmployeesWhoHaventMadeSales,EmployeesWhoHaveLessThan5Sales } from "./Modules/Empleado.mjs";
import {DeletePaciente, PostPaciente,GetPacientes, PutPaciente, PatientsWhoHavePurchased,PatientWhoSpentMostMoney,PatientsWhoBoughtInLastYear,PatientsWhoHaventBoughtAnythingBetween } from "./Modules/Paciente.mjs";
...
console.log(await PatientsWhoHaventBoughtAnythingBetween(date1,date2,token))
